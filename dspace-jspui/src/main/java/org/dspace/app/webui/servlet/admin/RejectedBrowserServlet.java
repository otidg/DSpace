 ...
 * @version $Revision$
 */
public class RejectedBrowserServlet extends AbstractBrowserServlet
{
    /** log4j category */
    private static Logger log = Logger.getLogger(RejectedBrowserServlet.class);
    ...
    protected void showNoResultsPage(Context context, HttpServletRequest request, HttpServletResponse response)
            ...
            AuthorizeException
    {
        request.setAttribute("browseRejected", "yes");
