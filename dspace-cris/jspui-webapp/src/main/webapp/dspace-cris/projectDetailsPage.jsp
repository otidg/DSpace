	 ...
	 <div class="col-lg-12">
		<div class="form-inline">
		 ...
		 <div class="form-group pull-right" style="margin-top:1.5em;">
			  <div class="btn-group">
				 <a class="btn btn-default"  href="<%= request.getContextPath() %>/cris/stats/pj.html?id=${entity.uuid}"><i class="fa fa-bar-chart-o"></i> <fmt:message key="jsp.cris.detail.link.statistics" /> </a>
			  <c:choose>
